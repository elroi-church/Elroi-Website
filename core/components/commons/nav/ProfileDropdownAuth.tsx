...
const ProfileDropdownAuth: FunctionComponent<ProfileDropdownAuthProps> = ({
  ...
  return (
    <div className="text-right text-sm text-white bg-transparent font-bold rounded-md transition duration-200">
          ...
          <Menu.Items className="absolute right-0 w-56 mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            <div className="px-1 py-1">
              <Menu.Item>
                {({ active }) => (
                  <button
                    className="group flex lg:inline-block pl-2 py-2 w-full text-sm text-white bg-primary hover:bg-primary-darker font-bold rounded-md transition duration-200"
                    onClick={() => signOut()}
                    // className={`${
                    //   active ? "bg-violet-500 text-white" : "text-gray-900"
                    // } group flex rounded-md items-center w-full px-2 py-2 text-sm`}
