        ...
        <section className="py-24 bg-white">
          <div className="container px-4 mx-auto">
            ...
            <div className="flex flex-wrap items-center -mx-4 mb-12 md:mb-16">
              <div className="flex flex-wrap w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
                <div className="w-full md:w-auto md:px-4">
                  <a
                    className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md"
                    href="#"
                  >
              ...
              <div className="flex flex-wrap w-full xl:w-1/2 px-4 mb-8 xl:mb-0 md:-mx-4">
                <div className="w-full md:w-auto md:px-4">
                  <a
                    className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md"
                    href="#"
              ...
              <div className="flex flex-wrap w-full xl:w-1/2 px-4 md:-mx-4">
                <div className="w-full md:w-auto md:px-4">
                  <a
                    className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md"
                    href="#"
            ...
            <div className="flex justify-center mx-auto max-w-max bg-white border border-coolGray-100 rounded-md shadow-lg">
              ...
              <a
                className="inline-flex items-center justify-center w-11 h-11 text-coolGray-300 hover:text-yellow-500 font-medium border-r border-coolGray-100"
                href="#"
              >
                1
              </a>
