...
const Giving: NextPage = () => {
  return (
    <MainLayout>
      ...
      <section className="px-10 py-20 mx-auto max-w-4xl">
        <h1 className="text-center text-5xl font-semibold">Online Giving</h1>
        <p className="text-center py-5 text-2xl tracking-wider">
          Simple and secure. Give a single gift, or schedule recurring giving
          using your checking account, debit, or credit card.
        </p>
        <div className="flex justify-center">
          <a
            className="block uppercase sm:inline-block py-4 px-20 rounded-2xl mb-4 sm:mb-0 sm:mr-3 text-md text-white text-center font-semibold leading-none bg-primary hover:bg-primary-darker"
            href="#"
          >
            Give Now
          </a>
