    ...
    <>
      <MainLayout>
        ...
        <div className="mt-2 px-5 lg:mt-10  lg:mx-[40px] flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 my-auto px-2 mr-0 lg:mr-4">
            <h2 className="font-bold text-xl">WHO WE ARE</h2>
            <br />
            <p className="font-light mb-2 lg:mb-0 text-justify indent-20">
          ...
          <div className="w-full lg:w-1/5 my-auto mt-10 lg:mt-0">
        ...
        <div className="mt-10">
          ...
          <div className="my-5 lg:my-[70px]">
            <div className="w-full xl:w-3/4 m-auto px-10 relative">
              ...
              <div className="absolute text-white left-[75px] bottom-[40px]">
                <h2 className="font-bold text-xl md:text-3xl">DANCE CLASS</h2>
